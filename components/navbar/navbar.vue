<template>
	<view class="nav">
		...
		<!-- Navbar内容区 -->
		<view v-if="isHome" class="homeNav" :style="'height:'+containerHeight
		+'rpx;line-height:'+containerHeight
		+'rpx;padding-left:20rpx;'">
			<text class="city">中部地区</text>
			<view style="flex: 1;">
				<navigator url="../../pages/search/index" :style="'height:' + menuButton.height*2 
